                        ...
                        <div>
                            ...
                            <div class="mt-4 mb-4 hidden">
                                <x-jet-label value="ID:" />
                                    <x-jet-input type="text" name="awkicliente_id" value="{{ $expedientee->awkicliente_id }}" readonly class="w-full" />
                                    <x-jet-input type="text" name="awkitienda_id" value="{{ $expedientee->awkitienda_id}}" readonly class="w-full" />
                                    <x-jet-input type="text" name="awkizona_id" value="{{ $expedientee->awkizona_id }}" readonly class="w-full" />
                            ...
                            <div class="flex">
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-jet-input type="text" name="numdocumento" value="{{ old('numdocumento') }}"
                                        class="w-full" />
                                    <x-jet-input-error for="numdocumento" />
                                </div>
                            </div>
