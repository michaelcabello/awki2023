<div wire:init="loadStatussunarp">
    <x-slot name="header">
        <div class="flex items-center">
            <h2 class="text-xl font-semibold leading-tight text-gray-600">
                Lista de Status Sunarp
            </h2>
        </div </x-slot>
        ...
        <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Statussunarp Create')
                        @livewire('admin.statussunarp.statussunarp-create')
                    @endcan
                ...
                @if (count($statussunarps))
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($statussunarps as $statussunarp)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Statussunarp Update')
                                            <a wire:click="edit({{ $statussunarp }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Statussunarp Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteStatussunarp', {{ $statussunarp->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="statussunarp.nombre" />
        ...
        @push('scripts')
            ...
            <script>
                Livewire.on('deleteStatussunarp', statussunarpId => {
                    Swal.fire({
                        title: 'Estas seguro?',
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.statussunarp.statussunarp-list', 'delete', statussunarpId);
