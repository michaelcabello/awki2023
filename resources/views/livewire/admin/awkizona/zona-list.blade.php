        ...
        <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Zona Create')
                        @livewire('admin.awkizona.zona-create')
                    @endcan
                    {{--                 <div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @switch($zonaa->state)
                                            ...
                                            @case(1)
                                                <span wire:click="desactivar({{ $zonaa }})"
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        @can('Zona Update')
                                            <a wire:click="edit({{ $zonaa }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Zona Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteZona', {{ $zonaa->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <select wire:model="awkizona.awkirepresentada_id" class="py-0.7 rounded" style="height:100%; width:100%">
