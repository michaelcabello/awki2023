                            ...
                            @foreach ($statusfinals as $statusfinal)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Statusfinal Update')
                                        <a wire:click="edit({{ $statusfinal }})" class="btn btn-green"><i
                                                class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Statusfinal Delete')
                                        <a class="btn btn-red"
                                            wire:click="$emit('deleteStatus', {{ $statusfinal->id }})">
