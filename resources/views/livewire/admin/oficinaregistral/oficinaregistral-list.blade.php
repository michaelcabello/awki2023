<div wire:init="loadOficinaregistral">
    <x-slot name="header">
        <div class="flex items-center">
            <h2 class="text-xl font-semibold leading-tight text-gray-600">
                Lista de Oficinas Registrales
            </h2>
        </div </x-slot>
        ...
        <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Oficinaregistral Create')
                        @livewire('admin.oficinaregistral.oficinaregistral-create')
                    @endcan
                ...
                @if (count($oficinaregistrals))
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($oficinaregistrals as $oficinaregistral)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                        {{ $oficinaregistral->nombre }}
                                    </td>


                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @switch($oficinaregistral->state)
                                            @case(0)
                                                <span wire:click="activar({{ $oficinaregistral }})"
                                            ...
                                            @case(1)
                                                <span wire:click="desactivar({{ $oficinaregistral }})"
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Oficinaregistral Update')
                                            <a wire:click="edit({{ $oficinaregistral }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Oficinaregistral Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteOficinaregistral', {{ $oficinaregistral->id }})">
                    ...
                    @if ($oficinaregistrals->hasPages())
                        <div class="px-6 py-4">
                            {{ $oficinaregistrals->links() }}
                        </div>
                    @endif
                @else
                    <div class="px-6 py-4">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            <x-slot name="title">
                Modificando La oficina Registral
            </x-slot>
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="oficinaregistral.nombre" />
                    <x-jet-input-error for="nombre" />
                </div>

                <div class="mb-4">
                    Estado
                    <x-jet-input type="checkbox" wire:model="oficinaregistral.state" />
        ...
        @push('scripts')
            ...
            <script>
                Livewire.on('deleteOficinaregistral', oficinaregistralId => {
                    Swal.fire({
                        title: 'Estas seguro?',
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.oficinaregistral.oficinaregistral-list', 'delete', oficinaregistralId);
