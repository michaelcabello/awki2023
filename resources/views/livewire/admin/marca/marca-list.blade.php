        ...
        <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Marca Create')
                        @livewire('admin.marca.marca-create')
                    @endcan
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @switch($marca->state)
                                            ...
                                            @case(1)
                                                <span wire:click="desactivar({{ $marca }})"
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Marca Update')
                                            <a wire:click="edit({{ $marca }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Marca Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteMarca', {{ $marca->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="marca.nombre" />
                    <x-jet-input-error for="nombre" />
                </div>

                <div class="mb-4">
                    Estado
                    <x-jet-input type="checkbox" wire:model="marca.state" />
                ...
                Livewire.on('deleteMarca', marcaId => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.marca.marca-list', 'delete', marcaId);
