<div wire:init="loadTipodedocumento">
    <x-slot name="header">
        <div class="flex items-center">
            <h2 class="text-xl font-semibold leading-tight text-gray-600">
                Lista de Tipodedocumentos
            </h2>
        </div </x-slot>
        ...
        <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Statusfinal Create')
                        @livewire('admin.statusfinal.statusfinal-create')
                    @endcan
                    {{--                 <div>
                            ...
                            @foreach ($tipodedocumentos as $tipodedocumento)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Tipodedocumento Update')
                                        <a wire:click="edit({{ $tipodedocumento }})" class="btn btn-green"><i
                                                class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Tipodedocumento Delete')
                                        <a class="btn btn-red"
                                            wire:click="$emit('deleteTipodedocumento', {{ $tipodedocumento->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            <x-slot name="title">
                Modificando el Tipode Document
            </x-slot>
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="statusfinal.nombre" />
                ...
                Livewire.on('deleteStatus', statusId => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.statusfinal.statusfinal-list', 'delete', statusId);
