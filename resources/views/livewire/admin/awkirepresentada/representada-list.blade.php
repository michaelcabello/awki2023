<div wire:init="loadRepresentadas">
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
                ...
                <x-table>
                        ...
                        <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                            ...
                            @can('Representada Create')
                                @livewire('admin.awkirepresentada.representada-create')
                            @endcan
            {{--                 <div>
                        ...
                        @if (count($representadas))
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    @foreach ($representadas as $representadaa)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                                {{ $representadaa->razonsocial }}
                                            </td>



                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @switch($representadaa->state)
                                                    @case(0)
                                                    ...
                                                    @break
                                                    @case(1)
                                                        <span wire:click="desactivar({{ $representadaa }})"
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                @can('Representada Update')
                                                    <a wire:click="edit({{ $representadaa }})" class="btn btn-green"><i class="fa-solid fa-pen-to-square"></i></a>
                                                @endcan
                                                @can('Representada Update')
                                                    <a class="btn btn-red" wire:click="$emit('deleteRepresentada', {{ $representadaa->id }})" >
    ...
    <x-jet-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.razonsocial" />
                <x-jet-input-error for="awkirepresentada.razonsocial"/>
            </div>
            <div class="mb-4">
                <x-jet-label value="address" />
                <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.address" />
                <x-jet-input-error for="address"/>
            </div>
            <div class="flex">
                <div class="mb-4 mr-1">
                    <x-jet-label value="ruc" />
                    <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.ruc" />
                ...
                <div class="mb-4 mr-1">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.phone" />
                    <x-jet-input-error for="phone"/>
                </div>

                <div class="mb-4">
                    <x-jet-label value="movil" />
                    <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.movil" />
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.nota1" />
                <x-jet-input-error for="nota1"/>
            </div>

            <div class="mb-4">
                <x-jet-label value="nota2" />
                <x-jet-input type="text" class="w-full" wire:model="awkirepresentada.nota2" />
                <x-jet-input-error for="nota2"/>
            </div>

            <div>
                 <x-jet-label value="Estado" />
                <x-jet-input type="checkbox" wire:model="awkirepresentada.state" />
    ...
    @push('scripts')
       ...
       <script>
        Livewire.on('deleteRepresentada', representadaId => {
            Swal.fire({
                title: 'Estas seguro?',
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('admin.awkirepresentada.representada-list','delete',representadaId);
