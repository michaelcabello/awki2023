            ...
            <x-table>
                ...
                <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                    ...
                    @can('Categoria Create')
                        @livewire('admin.categoria.categoria-create')
                    @endcan
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Categoria Update')
                                            <a wire:click="edit({{ $categoria }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Categoria Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteCategoria', {{ $categoria->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="categoria.nombre" />
                ...
                Livewire.on('deleteCategoria', categoriaId => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.categoria.categoria-list', 'delete', categoriaId);
