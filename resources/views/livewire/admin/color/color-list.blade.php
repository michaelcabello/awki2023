                            ...
                            @foreach ($colors as $color)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        @can('Color Update')
                                            <a wire:click="edit({{ $color }})" class="btn btn-green"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        @endcan
                                        @can('Color Delete')
                                            <a class="btn btn-red" wire:click="$emit('deleteColor', {{ $color->id }})">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="color.nombre" />
                ...
                Livewire.on('deleteColor', colorId => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.emitTo('admin.color.color-list', 'delete', colorId);
